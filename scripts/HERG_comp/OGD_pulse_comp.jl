...
#retrieving data
source_file = "model=KBZR-OGD_prot_name=pulse_dt=0.001_P1=-20.jld2" #name of file to be loaded (path not needed, extension needed)
#source_file = "model=KBZR-OGD_prot_name=pulse_dt=0.001_P1=0.jld2" 
#source_file = "model=KBZR-OGD_prot_name=pulse_dt=0.001_P1=20.jld2" 
