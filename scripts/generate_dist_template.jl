...
model = " " #file in "/src/" containing function "Gmatrix" for transition rate matrix. no suffix. path not needed
...
protocol = IonChannelTools.... #function for calculating protocol, must take input in form (tbound,dt,args)
