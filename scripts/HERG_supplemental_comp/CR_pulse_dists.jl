...
plt1 = plot(legend=:topright,title="Distance from steady state (CR)",xaxis="time [ms]",yaxis="Occupancy difference [%]")#,size=(400,400),title="B",titlelocation=:left) #full graph
