...
model = "K5" #file in "/src/" containing function "Gmatrix" for transition rate matrix. no suffix. path not needed
...
Largs = "ib" #arguments for protocol function, array or string as relevant
