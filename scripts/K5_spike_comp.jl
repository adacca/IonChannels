...
#retrieving data
source_file = "model=K5_prot_name=spike_dt=0.001_Largs=ib_tbound=200.jld2" #name of file to be loaded (path not needed, extension needed)
...
I = IonChannelTools.I_avg(dict["tL"][:,2],-80,dict["dists"],[0 0 0 0 1])
